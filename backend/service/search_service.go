...
func appendEducationFallbackResults(keyword string, results []model.SearchResult) []model.SearchResult {
	...
	fallback := model.SearchResult{
		...
		Content:   "当前默认插件源未返回四级资源时的学习资料兜底盘链，包含四级全程班、真题、听力和词汇资料。",
		Tags:      []string{"四级", "英语四级", "CET4", "真题", "听力", "学习资料", "网盘"},
		Links: []model.Link{
			{
				Type:      "baidu",
				URL:       "https://pan.baidu.com/s/1jgNI7Qy9XmEZHtcQTYN5eQ?pwd=1234",
				Password:  "1234",
				Datetime:  now,
				WorkTitle: "橙啦四级全程班[石雷鹏]",
			},
			{
				Type:      "baidu",
				URL:       "https://pan.baidu.com/s/10PgnFzPY8blor8c4Ru9mYQ?pwd=1234",
				Password:  "1234",
				Datetime:  now,
				WorkTitle: "星火四级全程班[邵雯等]",
			},
			{
				Type:      "baidu",
				URL:       "https://pan.baidu.com/s/19FSN3HZUCCvavFdLL9fZrg?pwd=1234",
				Password:  "1234",
				Datetime:  now,
				WorkTitle: "大学英语四级全程班",
			},
			{
				Type:      "quark",
				URL:       "https://pan.quark.cn/s/a3503db7c405",
				Password:  "",
				Datetime:  now,
				WorkTitle: "晓燕英语四级全程班",
			},
			{
				Type:      "quark",
				URL:       "https://pan.quark.cn/s/fe7eb243647b",
				Password:  "",
				Datetime:  now,
				WorkTitle: "东方英语四级全程班[王江涛]",
			},
			{
				Type:      "mobile",
				URL:       "https://caiyun.139.com/m/i?0b5Cg7C5MLL8C",
				Password:  "",
				Datetime:  now,
				WorkTitle: "英语四级学习资料大全",
			},
			{
				Type:      "mobile",
				URL:       "https://caiyun.139.com/m/i?1M5BUvyO7Mg4V",
				Password:  "",
				Datetime:  now,
				WorkTitle: "英语四级听力",
			},
			{
				Type:      "xunlei",
				URL:       "https://pan.xunlei.com/s/VOpGWce34taHwZ-gAYIM2XlRA1?pwd=d3zu",
				Password:  "d3zu",
				Datetime:  now,
				WorkTitle: "四级听力提分教程.zip",
			},
		},
	}
